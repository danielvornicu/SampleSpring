 ...
 * 
 */
@WebServiceClient(name = "TestWSService", targetNamespace = "http://jaxws.web.dev.tech/", wsdlLocation = "http://localhost:1111/crm/jaxws/TestWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTWSSERVICE_QNAME = new QName("http://jaxws.web.dev.tech/", "TestWSService");
    ...
    public TestWS getTestWSPort() {
        return super.getPort(new QName("http://jaxws.web.dev.tech/", "TestWSPort"), TestWS.class);
    }
    ...
    public TestWS getTestWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws.web.dev.tech/", "TestWSPort"), TestWS.class, features);
    }
